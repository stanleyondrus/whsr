...
# Customization
To use custom sounds, replace ***Windows Hardware Insert1.wav*** and ***Windows Hardware Remove1.wav*** in the root folder with your own files. As long as you keep the name and format identical, the script will use corresponding sounds.